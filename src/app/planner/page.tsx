            ...
            <CardContent>
              ...
              >
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <label className="flex flex-col gap-1">
                    <span className="text-xs font-medium text-slate-200">Experience level</span>
                    <select
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <label className="flex flex-col gap-1">
                    <span className="text-xs font-medium text-slate-200">Days per week</span>
                    <Input
                      name="daysPerWeek"
                      type="number"
                      min={1}
                  ...
                  <label className="flex flex-col gap-1">
                    <span className="text-xs font-medium text-slate-200">Time per workout (minutes)</span>
                    <Input
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-xs font-medium text-slate-200">Injuries / limitations</span>
                  <Textarea
                    name="injuries"
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-xs font-medium text-slate-200">Preferences</span>
                  <Textarea
                    name="preferences"
              ...
              {loading && (
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-slate-300">Generating your plan...</p>
                  </div>
                  <LoadingPlanSkeleton />
                </div>
              )}
    ...
    <>
      ...
      >
        ...
        >
            ...
            <button
              ...
              className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {selected.length > 0 && (
              <div className="mt-8 pt-6 border-t border-slate-700">
                <p className="text-xs text-slate-400 mb-3 text-center">Selected areas ({selected.length})</p>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <p className="text-xs font-semibold text-slate-200">Body Map</p>
          <div className="flex items-center gap-3">
            {/* Expand button */}
            <button
              type="button"
              ...
              className="flex items-center justify-center w-7 h-7 rounded-md bg-slate-800/60 hover:bg-slate-700 text-slate-400 hover:text-white transition-all duration-200 hover:scale-110"
              title="Expand body map"
            >
              <Maximize2 className="w-4 h-4" />
            </button>
            <span className="text-[10px] text-sky-400">Click areas to tag discomfort</span>
          </div>
        </div>
